...
def export_fred_data(date_start,date_end):
    ...
    pcec96 = fred.get_series("PCEC96", observation_start=date_start, observation_end=date_end, freq="monthly")
    pcec96.to_csv(cwd+"pce.csv")
    pcec96_10 = fred.get_series("PCEC96", observation_start=date_start2, observation_end=date_end, freq="monthly")
    ...
    real_pers = fred.get_series("W875RX1", observation_start=date_start, observation_end=date_end, freq="monthly")
    real_pers.to_csv(cwd+"real_pers.csv")
    real_pers_10 = fred.get_series("W875RX1", observation_start=date_start2, observation_end=date_end, freq="monthly")
    ...
    retail_sales_10 = fred.get_series("RRSFS", observation_start=date_start2, observation_end=date_end, freq="monthly")
    retail_sales_10.to_csv(cwd+"retail_sales10.csv")


    employment_level = fred.get_series("CE16OV", observation_start=date_start, observation_end=date_end, freq="monthly")
    employment_level.to_csv(cwd+'employment_level.csv')
    employment_level_10 = fred.get_series("CE16OV", observation_start=date_start2, observation_end=date_end, freq="monthly")
    ...
    wages_10 = fred.get_series("CES0500000003", observation_start=date_start2, observation_end=date_end, freq="monthly")
    ...
    core_cpi_10 = fred.get_series("CPILFESL", observation_start=date_start2, observation_end=date_end, freq="monthly")
    core_cpi_10.to_csv(cwd + 'core_cpi10.csv')

    core_pce = fred.get_series("DPCCRC1M027SBEA", observation_start=date_start, observation_end=date_end, freq="monthly")
    core_pce.to_csv(cwd + 'core_pce.csv')
    core_pce_10 = fred.get_series("DPCCRC1M027SBEA", observation_start=date_start2, observation_end=date_end, freq="monthly")
